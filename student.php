...
<li>
    ...
    <?php
        ...
        $result_sql=mysqli_query($conn,"SELECT `p1`, `p2`, `p3`, `p4`, `p5`, `p6`, `p7`, `p8`, `p9`, `p10`, `p11`, `marks`, `percentage` FROM `result` WHERE `rno`='$rn' and `class`='$class'");
    ...
    <div class="container">
        ...
        <div class="main">
            <div class="s1">
                ...
                <p>Chemistry :</p>
                <p>programing in c :</p>
               <p>Basics of computer Engineering :</p>
               <p>Engineering drawing :</p>
               <p>programing in c Lab :</p>
               <p>physics Lab:</p>
               <p>Chemistry Lab :</p>
               <p>Computer fundamental Lab :</p>
            </div>
            <div class="s2">
                <p>Marks</p>
                <?php echo '<p>'.$p1.'</p>';?>
